...
namespace CyberMinds.Web.Controllers
{
    public class ClientesController : Controller
    {
        ...
        public ClientesController(CyberMindsContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre,Apellido,Email,Telefono,Direccion,Ciudad,Estado,Pais")] Cliente cliente)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre,Apellido,Email,Telefono,Direccion,Ciudad,Estado,Pais")] Cliente cliente)
        {
            if (id != cliente.Id)
            {
                return NotFound();
